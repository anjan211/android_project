...
public class WeekSpendingActivity extends AppCompatActivity {
    ...
    private TextView totalWeekAmountText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        totalWeekAmountText = findViewById(R.id.totalWeekAmountTextView);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot ds: snapshot.getChildren()){
                    ...
                    totalWeekAmountText.setText("Total Month's Spending : €" +totalAmount);
                }
            }
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot ds: snapshot.getChildren()){
                    ...
                    totalWeekAmountText.setText("Total Week's Spending : €" +totalAmount);
                }
            }
